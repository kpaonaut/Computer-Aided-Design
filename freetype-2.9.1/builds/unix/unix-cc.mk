...
#
CPPFLAGS := 
CFLAGS   := -c -Wall -g -O2 -fvisibility=hidden -DDARWIN_NO_CARBON   -I/usr/local/Cellar/libpng/1.6.29/include/libpng16 -DFT_CONFIG_CONFIG_H="<ftconfig.h>"
...
# Linker flags.
#
LDFLAGS           :=  -lz -lbz2 -L/usr/local/Cellar/libpng/1.6.29/lib -lpng16
